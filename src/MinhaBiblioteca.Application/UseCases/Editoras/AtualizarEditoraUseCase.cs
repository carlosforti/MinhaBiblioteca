...
{
    public class AtualizarEditoraUseCase: IAtualizarEditoraUseCase
    {
        private readonly IMapper _mapper;
        private readonly IEditoraRepository _editoraRepository;
        private readonly INotificador _notificador;
        
        public AtualizarEditoraUseCase(IMapper mapper, IEditoraRepository editoraRepository, INotificador notificador)
        {
            _mapper = mapper;
